...
export const progress = {
  ...
  categories: [
    ...
    { key: 'sceneDrawing', label: 'Scene Drawing', value: 44 },
    { key: 'scenePolish', label: 'Scene Polish', value: 41 },
  ...
  chapters: [
    ...
    { key: 'book1-chapter2', label: 'Book 1 · Chapter 02', value: 68, status: 'active' },
