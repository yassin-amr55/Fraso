...
export const progress = {
  ...
  categories: [
    ...
    { key: 'sceneDrawing', label: 'Scene Drawing', value: 45 },
    { key: 'scenePolish', label: 'Scene Polish', value: 43 },
  ...
  chapters: [
    ...
    { key: 'book1-chapter2', label: 'Book 1 · Chapter 02', value: 70, status: 'active' },
