...
export const progress = {
  ...
  categories: [
    ...
    { key: 'sceneDrawing', label: 'Scene Drawing', value: 47 },
    { key: 'scenePolish', label: 'Scene Polish', value: 45 },
  ...
  chapters: [
    ...
    { key: 'book1-chapter2', label: 'Book 1 · Chapter 02', value: 75, status: 'active' },
