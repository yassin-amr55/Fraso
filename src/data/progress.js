...
export const progress = {
  ...
  categories: [
    ...
    { key: 'sceneDrawing', label: 'Scene Drawing', value: 46 },
    { key: 'scenePolish', label: 'Scene Polish', value: 44 },
  ...
  chapters: [
    ...
    { key: 'book1-chapter2', label: 'Book 1 · Chapter 02', value: 74, status: 'active' },
